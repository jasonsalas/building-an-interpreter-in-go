...
func TestEvalIntegerExpression(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		testIntegerObject(t, evaluated, testCase.want)
	}
}
...
func TestEvalBooleanExpression(t *testing.T) {
	...
	for _, testCase := range testCases {
		evaluated := testEval(testCase.input)
		testBooleanObject(t, evaluated, testCase.want)
	}
}
...
`,
	...
	for _, testCase := range testCases {
		...
		if errObj.Message != testCase.wantMessage {
			t.Errorf("wrong error message || want: %q, got: %q", testCase.wantMessage, errObj.Message)
		}
	}
}
...
func TestLetStatements(t *testing.T) {
	...
	for _, testCase := range testCases {
		testIntegerObject(t, testEval(testCase.input), testCase.want)
	}
}
...
func testIntegerObject(t *testing.T, obj object.Object, want int64) bool {
	...
	if result.Value != want {
		t.Errorf("object has the wrong value || got: %d, want: %d", result.Value, want)
		return false
	}
